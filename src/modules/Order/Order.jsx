				...
				{isOrderReady ?
					...
					<>
						...
						<form className={s.form} id="order">
							...
							<fieldset className={s.fieldset}>
								...
								<div className={s['order__input-group']}>
									...
									<input className={classNames(s.order__input, s.order__input_min)} type="text" name="house" placeholder="Дом" />
									<input className={classNames(s.order__input, s.order__input_min)} type="text" name="apartment" placeholder="Квартира" />
								</div>
							</fieldset>
							<fieldset className={s.fieldset}>
								<div className={s.payment}>
									<label className={s['label-radio']}>
										<input className={s.radio} type="radio" name="payment-online" value="true" defaultChecked />
										Оплата онлайн</label>
								</div>
						...
						<div className={s.footer}>
							...
							<button className={s.button} type="submit" form="order">Заказать</button>
						</div>
					</>
				}
			</div >
